...
using SmartTicketPortal.Controllers;
...
namespace SmartTicketPortal.Controllers
{
    public class TicketBookingController : ApiController
    {
        ...
        [HttpPost]
        [Route("api/TicketBooking/SaveBookedTicket")]
        public int SaveBookedTicket(BookedTicketDetails B)
        {
            ...
            try
            {
                ...
                SqlParameter TransId = new SqlParameter("@TransId", SqlDbType.VarChar, 25);
                TransId.Value = B.TransId;
                PnrDeatilscmd.Parameters.Add(TransId);
                ...
                SqlParameter TicketContent = new SqlParameter("@TicketContent", SqlDbType.VarChar);
                TicketContent.Value = B.TicketContent;
                PnrDeatilscmd.Parameters.Add(TicketContent);
                ...
                if (bookingId != null)
                {
                    try
                    {
                        ...
                        string verifcodeMail = B.TicketContent;
